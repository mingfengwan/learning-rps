...
//altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=1 WIDTH_EXP=8 WIDTH_MAN=23 aeb agb alb clock dataa datab
...
//synthesis_resources = lpm_compare 4 reg 3 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float_compare_altfp_compare_clb
	( 
	aeb,
	agb,
	alb,
...
endmodule //float_compare_altfp_compare_clb
//VALID FILE
...
module float_compare (
	...
	float_compare_altfp_compare_clb	float_compare_altfp_compare_clb_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.aeb (sub_wire0),
